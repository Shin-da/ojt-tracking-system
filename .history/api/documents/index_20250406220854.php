    ...
    public function create() {
        ...
        try {
            ...
            if (!in_array($file['type'], $allowed_types)) {
                return $this->sendResponse(false, 'Invalid file type. Allowed types: PDF, DOC, DOCX', null, 400);
            }
            ...
            if (!file_exists($this->upload_dir)) {
                if (!mkdir($this->upload_dir, 0777, true)) {
                    return $this->sendResponse(false, 'Failed to create upload directory', null, 500);
                }
            }
            ...
            if (!is_writable($this->upload_dir)) {
                ...
                if (!is_writable($this->upload_dir)) {
                    return $this->sendResponse(false, 'Upload directory is not writable', null, 500);
                }
            }
            ...
            if (!move_uploaded_file($file['tmp_name'], $file_path)) {
                ...
                return $this->sendResponse(false, 'Failed to save file: ' . ($error['message'] ?? 'Unknown error'), null, 500);
            }

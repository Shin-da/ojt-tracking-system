...
import { FaHome, FaClock, FaBook, FaFileAlt, FaChartBar } from 'react-icons/fa';
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <div className="flex space-x-4">
            ...
            <Link to="/reports" className="flex items-center px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100">

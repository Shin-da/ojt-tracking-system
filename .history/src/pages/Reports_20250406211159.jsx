...
import { format, parseISO, startOfWeek, endOfWeek, startOfMonth, endOfMonth, eachWeekOfInterval, eachDayOfInterval, isSameMonth, differenceInWeeks, addWeeks, addBusinessDays, differenceInDays } from 'date-fns';
import { FaCalendarAlt, FaDownload, FaChartBar, FaFilePdf, FaFileExcel, FaPrint, FaExchangeAlt, FaInfoCircle } from 'react-icons/fa';
...
const Reports = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {error && (
        <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded no-print">
          <p>{error}</p>
        </div>
      )}
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            <h3 className="text-sm font-medium text-gray-500 mb-2">Hours Progress</h3>
            <div className="flex items-end justify-between">
              <div>
                <p className="text-3xl font-bold text-blue-600">{summaryStats.total_hours.toFixed(1)}</p>
                <p className="text-xs text-gray-500">of {summaryStats.required_hours} required hours</p>
              </div>
          ...
          {/* Completion Estimate */}
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            <h3 className="text-sm font-medium text-gray-500 mb-2">Completion Estimate</h3>
            <div>
          ...
          {/* Averages & Goals */}
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            <h3 className="text-sm font-medium text-gray-500 mb-2">Averages & Goals</h3>
            <div className="grid grid-cols-2 gap-2">
              <div>
                <p className="text-lg font-bold text-gray-800">{summaryStats.daily_average.toFixed(1)}</p>
                <p className="text-xs text-gray-500">hours/day average</p>
              </div>
              <div>
                <p className="text-lg font-bold text-gray-800">{summaryStats.total_days}</p>
                <p className="text-xs text-gray-500">days logged</p>
              </div>
              {summaryStats.estimated_completion_days > 0 && (
                <>
                  <div>
                    <p className="text-lg font-bold text-gray-800">{summaryStats.weekly_average}</p>
                    <p className="text-xs text-gray-500">hours/week needed</p>
                  </div>
                  <div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
          ...
          <div className="flex flex-wrap items-center gap-2 no-print">
            ...
            <div className="flex items-center space-x-1">
              ...
              <button
                className="flex items-center bg-gray-600 text-white px-3 py-2 rounded-md hover:bg-gray-700"
        ...
        {/* Date Navigation */}
        <div className="flex justify-between items-center mb-6 mt-4 bg-gray-50 p-3 rounded-lg no-print">
          <button 
      ...
      <div className="mt-6">
        <h3 className="font-medium text-gray-700 mb-2">Hours Heatmap</h3>
      ...
      {compareMode && (
        <div className="mt-6 mb-6">
          <h3 className="font-medium text-gray-700 mb-2">Period Comparison</h3>

...
const TimeLog = () => {
  ...
  return (
    <div className="space-y-8 bg-[#EDEID2] p-8 min-h-screen">
      <h1 className="text-5xl font-extrabold text-[#412F26] flex items-center space-x-4">
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg border border-[#CBB89D]/30">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl font-semibold text-[#412F26]">Add Time Log</h2>
          <button
            onClick={() => setShowBulkLog(!showBulkLog)}
            className="px-5 py-3 text-sm font-medium bg-[#6A6F4C] text-white rounded-lg hover:bg-[#5D2510] transition-transform transform hover:scale-105"
          >
        ...
        {showBulkLog ? (
          <form onSubmit={handleBulkSubmit} className="space-y-6">
            <div>
              <label className="block text-lg font-medium text-[#806044] mb-3">Select Dates</label>
              <Calendar
                ...
                maxDate={new Date()}
                selectRange={true}
                className="border rounded-lg p-4 w-full shadow-sm"
                tileClassName={({ date }) => {
              ...
              {selectedDates.length > 0 && (
                <p className="text-sm text-[#806044] mt-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-lg font-medium text-[#806044]">Time In</label>
                <input
                  type="time"
                  name="timeIn"
                  className="mt-2 block w-full px-4 py-3 bg-white border border-[#CBB89D] rounded-lg shadow-sm focus:outline-none focus:ring-[#6A6F4C] focus:border-[#6A6F4C]"
              ...
              <div>
                <label className="block text-lg font-medium text-[#806044]">Time Out</label>
                <input
                  type="time"
                  name="timeOut"
                  className="mt-2 block w-full px-4 py-3 bg-white border border-[#CBB89D] rounded-lg shadow-sm focus:outline-none focus:ring-[#6A6F4C] focus:border-[#6A6F4C]"
            ...
            <div>
              <label className="block text-lg font-medium text-[#806044]">Notes</label>
              <textarea
                name="notes"
                className="mt-2 block w-full px-4 py-3 bg-white border border-[#CBB89D] rounded-lg shadow-sm focus:outline-none focus:ring-[#6A6F4C] focus:border-[#6A6F4C]"
                rows={4}
            ...
            <button
              ...
              className="w-full bg-[#6A6F4C] text-white py-3 px-5 rounded-lg hover:bg-[#5D2510] transition-transform transform hover:scale-105 disabled:opacity-50"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-lg font-medium text-[#806044]">Date</label>
              <input
                type="date"
                name="date"
                className="mt-2 block w-full px-4 py-3 bg-white border border-[#CBB89D] rounded-lg shadow-sm focus:outline-none focus:ring-[#6A6F4C] focus:border-[#6A6F4C]"
              ...
              >
                <div className="md:grid md:grid-cols-5 md:gap-6 space-y-4 md:space-y-0">
                  ...
                  <div className="col-span-1">
                    {log.notes ? (
                      <p className="text-lg text-[#412F26]">{log.notes}</p>
                    ) : (
                      <p className="text-lg text-[#CBB89D] italic">No notes</p>
                    )}
                  </div>

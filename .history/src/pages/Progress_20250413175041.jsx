...
const Progress = () => {
  ...
  const fetchTimeData = async () => {
    try {
      ...
      console.log('Monthly data entries:', data.data?.monthly_hours?.length || 0);
      console.log('Weekly data entries:', data.data?.weekly_hours?.length || 0);
      console.log('Heatmap data entries:', data.data?.heatmap_data?.length || 0);

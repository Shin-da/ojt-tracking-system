  ...
  return (
    <div className="bg-[#EDEID2] p-6 min-h-screen">
      <div className="flex items-center space-x-4 mb-8">
        <FaLeaf className="text-4xl text-[#6A6F4C]" />
        <h1 className="text-4xl font-bold text-[#412F26]">Growth Tracker</h1>
      </div>
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-[#CBB89D]/20">
              <h2 className="text-xl font-semibold text-[#412F26]">Journey Progress</h2>
              <p className="text-4xl font-bold text-[#6A6F4C] mt-3">{formatHours(stats.total_hours)}</p>
